...
const Strategies: React.FC = () => {
  ...
  return (
    <Styled.Container>
      ...
      <Styled.Content>
        {
          strategies && strategies.map(strategy => <StrategyInformation name={strategy.name} userRating={strategy.user_rating} riskLevel={strategy.risk_level} averageProfit={strategy.average_profit} />)
        }
      </Styled.Content>
    </Styled.Container>
  );
